  ...
  const handleRemove = (id: string, title: string) => {
    ...
    Alert.alert(
      ...
      [
        ...
        { text: "Remove", style: "destructive", onPress: () => removeListing.mutate(id) },
      ]
    );
  };
            ...
            >
              ...
              <View style={styles.cardMeta}>
                <View style={styles.metaItem}>
                  ...
                  <Text style={styles.metaItemText}>{listing.category}</Text>
                </View>
                <View style={styles.metaItem}>
                  <Feather name="dollar-sign" size={11} color={C.textTertiary} />
                  <Text style={styles.metaItemText}>R{Number(listing.price).toFixed(2)} / {listing.unit}</Text>
                </View>
                <View style={styles.metaItem}>
                  <Feather name="calendar" size={11} color={C.textTertiary} />
                  <Text style={styles.metaItemText}>{new Date(listing.created_at).toLocaleDateString("en-ZA")}</Text>
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  metaItemText: { fontSize: 12, fontFamily: "Inter_400Regular", color: C.textTertiary },
